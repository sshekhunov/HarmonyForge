...
public class ParallelOctavesCheckCommand : IHarmonyCheckCommand
{
    public string Title => "Параллельные октавы";
    public string Feedback => "Обнаружены параллельные октавы: два голоса движутся в одном направлении, сохраняя интервал октавы.";
